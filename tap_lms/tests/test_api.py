...
if __name__ == '__main__':
    print("=" * 80)
    print("RUNNING COMPLETE 100% COVERAGE TEST SUITE FOR tap_lms/api.py")
    print("=" * 80)
    
    if not API_MODULE_IMPORTED:
        print("ERROR: Cannot run tests - API module not available")
        exit(1)
    ...
    print("This test suite aims for 100% code coverage of tap_lms/api.py")
    print("=" * 80)