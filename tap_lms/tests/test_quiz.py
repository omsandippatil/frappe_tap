...
class TestQuiz(unittest.TestCase):
    """Minimal test cases for Quiz doctype to achieve 100% coverage"""
    
    def test_quiz_import_and_instantiation(self):
        """Test Quiz import and instantiation - covers all lines"""
        ...
        with patch.dict('sys.modules', {
            ...
            # This covers the import line: from frappe.model.document import Document
            from tap_lms.tap_lms.doctype.quiz.quiz import Quiz
            
            # This covers the class definition: class Quiz(Document):
            # This covers the pass statement when instantiating
            quiz = Quiz()
