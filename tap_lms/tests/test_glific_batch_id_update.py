...
class TestProcessMultipleSets:
    ...
    def test_processes_multiple_sets_successfully(self, mock_update, mock_sleep, mock_logger):
        """Test successful processing of multiple sets"""
        mock_update.side_effect = [
            {"updated": 3, "errors": 0, "skipped": 1, "total_processed": 4, "set_name": "SET001"},
            {"updated": 2, "errors": 1, "skipped": 0, "total_processed": 3, "set_name": "SET002"},
            {"updated": 0, "errors": 0, "skipped": 0, "total_processed": 0, "set_name": "SET002"},
            {"message": "No successfully processed students found", "set_name": "SET002"}
        ]
    ...
    def test_handles_errors_in_individual_sets(self, mock_update, mock_logger):
        """Test handling of errors in individual sets"""
        mock_update.side_effect = [
            {"updated": 5, "errors": 0, "skipped": 0, "total_processed": 5, "set_name": "SET001"},
            {"error": "Database connection error", "set_name": "SET002"}
        ]
    ...
    def test_continues_processing_after_set_error(self, mock_update, mock_logger, mock_sleep):
        ...
        def update_side_effect(set_name, batch_size=50):
            if set_name == "SET001":
                ...
                return {"error": "Database connection lost", "set_name": "SET002"}
            ...
            return {"total_processed": 0, "set_name": set_name}
...
class TestIntegrationScenarios:
    ...
    def test_mixed_success_and_failure_scenario(self, mock_get_doc, mock_get_all,
        ...
        side_effects = [mock_onboarding_set]
        for i in range(5):
